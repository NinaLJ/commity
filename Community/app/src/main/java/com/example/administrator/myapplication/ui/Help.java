...
public class Help extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_submit.setOnClickListener(button);
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = "http://10.7.92.57:8080/Community/analysis/submit_fb";
...
//      params.add("fb", "{\"FB_CONTENT\":\"反馈1\",\"FB_CONTACT\":\"1523015666\",\"FB_TIME\":"+"'"+time+"'"+"}" );
    ...
    private void getSubmit(){
         content = ed_content.getText().toString().trim();
          Toast.makeText(Help.this,"反馈成功",Toast.LENGTH_SHORT).show();
        if( content.equals("")){
            Toast.makeText(Help.this,"反馈内容不能为空",Toast.LENGTH_SHORT).show();
        }
        else{
            ed_content.setText("");
            ed_contact.setText("");
